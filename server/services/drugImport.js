...
const drugSchema = { type: "object", properties: { drug: { type: "object", properties: drugProperties, required: Object.keys(drugProperties), additionalProperties: false }, provenance: { type: "array", items: { type: "object", properties: { sourceId: { type: "string" }, title: { type: "string" }, organization: { type: "string" }, year: { type: "integer" }, url: { type: "string" }, pages: { type: "string" }, sections: { type: "array", items: { type: "string" } } }, required: ["sourceId", "title", "organization", "year", "url", "pages", "sections"], additionalProperties: false } } }, required: ["drug", "provenance"], additionalProperties: false };
...
const guidelineTableSchema = { type: "object", properties: { guideline: { type: "object", properties: { id: { type: "string" }, slug: { type: "string" }, title: { type: "string" }, titleVi: { type: "string" }, organization: { type: "string" }, publicationYear: { type: "integer" }, version: { type: "string" }, specialty: { type: "string" }, topics: { type: "array", items: { type: "string" } }, summary: { type: "string" }, sourceUrl: { type: "string" } }, required: ["id", "slug", "title", "titleVi", "organization", "publicationYear", "version", "specialty", "topics", "summary", "sourceUrl"], additionalProperties: false }, table: { type: "object", properties: { name: { type: "string" }, number: { type: "string" }, page: { type: "string" }, section: { type: "string" } }, required: ["name", "number", "page", "section"], additionalProperties: false }, rows: { type: "array", items: { type: "object", properties: { drugName: { type: "string" }, drugId: { type: "string" }, drugClass: { type: "string" }, brandNames: { type: "array", items: { type: "string" } }, dose: { type: "string" }, renalAdjustment: { type: "string" }, hepaticAdjustment: { type: "string" }, contraindications: { type: "string" }, monitoring: { type: "string" }, clinicalContext: { type: "string" }, relationType: { type: "string" }, page: { type: "string" }, section: { type: "string" }, tableCells: { type: "array", items: tableCellSchema } }, required: ["drugName", "drugId", "drugClass", "brandNames", "dose", "renalAdjustment", "hepaticAdjustment", "contraindications", "monitoring", "clinicalContext", "relationType", "page", "section", "tableCells"], additionalProperties: false } }, provenance: { type: "array", items: { type: "object", properties: { guidelineId: { type: "string" }, title: { type: "string" }, tableName: { type: "string" }, tableNumber: { type: "string" }, page: { type: "string" }, section: { type: "string" }, documentTitle: { type: "string" }, publicationYear: { type: "integer" }, organization: { type: "string" }, url: { type: "string" } }, required: ["guidelineId", "title", "tableName", "tableNumber", "page", "section", "documentTitle", "publicationYear", "organization", "url"], additionalProperties: false } } }, required: ["guideline", "table", "rows", "provenance"], additionalProperties: false };
...
export function validateDrugRecord(drug) {
  const errors = [];
  const warnings = [];
  if ((!drug?.id || typeof drug.id !== "string" || !drug.id.trim()) && (!drug?.slug || typeof drug.slug !== "string" || !drug.slug.trim())) errors.push("id: cần nhập id hoặc slug.");
