import { ArrowLeft, BookOpenCheck, ChevronRight, LayoutDashboard, Pill, ShieldCheck } from "lucide-react";
...
function breadcrumb(route: AdminRoute) {
  if (route.kind.startsWith("admin-drug")) return ["Thuốc", route.kind === "admin-drug-new" ? "Thêm thuốc" : route.drugId || "Danh sách"];
