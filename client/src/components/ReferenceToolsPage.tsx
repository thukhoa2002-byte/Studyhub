import { ArrowLeft, Calculator, Check, ChevronDown, ClipboardList, Edit3, FilePlus2, FileUp, FunctionSquare, Save, Search, Table2, Trash2, UploadCloud, X } from "lucide-react";
