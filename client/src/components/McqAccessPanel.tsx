...
export default function McqAccessPanel({ userEmail, open, onMouseEnter, onMouseLeave }: Props) {
  ...
  return (
    <aside className="mcq-access-popover fixed z-[70]" onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} aria-label="Quyền MCQ">
      ...
      <div className="mcq-access-popover__card mt-3 rounded-3xl border border-teal-200/80 bg-white/90 p-4 shadow-[0_18px_50px_rgba(15,118,110,.14)] backdrop-blur-xl">
