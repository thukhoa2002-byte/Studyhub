...
function JobReview({ data, items, selectedItems, setSelectedItems, visibleRecommendations, search, setSearch, blockingIssues, busy, onProcess, onResume, onImport, onDelete, onRefresh, onSectionChange, onRecommendationChange, onReviewRecommendationTable }: { data: GuidelineImportJobData; items: GuidelineImportItem[]; selectedItems: string[]; setSelectedItems: (items: string[]) => void; visibleRecommendations: GuidelineImportRecommendation[]; search: string; setSearch: (value: string) => void; blockingIssues: GuidelineImportJobData["issues"]; busy: boolean; onProcess: () => void; onResume: () => void; onImport: () => void; onDelete: () => void; onRefresh: () => void; onSectionChange: (section: GuidelineImportSection) => void; onRecommendationChange: (recommendation: GuidelineImportRecommendation) => void; onReviewRecommendationTable: (item: GuidelineImportItem) => void }) {
