...
function blank(): Partial<CalculatorDefinition> {
  return {
    ...
    interpretations: [], guidelineReferences: [], flashcardReferences: [], quizReferences: [], relatedCalculatorReferences: [],
