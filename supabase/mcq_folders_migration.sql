...
begin
  ...
  -- Do this explicitly instead of relying only on ON DELETE SET NULL.
  -- Existing projects may have an older foreign-key constraint that blocks
  -- deletion when a folder still contains banks or child folders.
